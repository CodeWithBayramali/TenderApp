    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    tenderId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    uniqueTenderName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferTenders", x => x.OfferId);
                    table.ForeignKey(
                        name: "FK_OfferTenders_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OfferTenders_Tenders_tenderId",
                        column: x => x.tenderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferTenders_UsersId",
                table: "OfferTenders",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferTenders_tenderId",
                table: "OfferTenders",
                column: "tenderId");
        }
